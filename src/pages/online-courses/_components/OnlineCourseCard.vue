...
<template>
    <div v-if="item" class="border w-full border-gray-400  dark:bg-slate-800 bg-white cursor-pointer">
        <div class="relative">
        ...
        <div>
            <h1 class="dark:text-white text-gray-900 text-[20px] font-bold p-[10px]">{{ item.title }}</h1>
        </div>
    </div>
</template>