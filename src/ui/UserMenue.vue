...
<template>
    ...
    <!-- <div class="">
        ...
        <ul class=" menu shadow-2xl border z-[10] p-2 w-[300px] text-gray-800 dark:text-white bg-white divide-y divide-gray-100 rounded-lg dark:bg-gray-700 dark:divide-gray-600">
            <li>
