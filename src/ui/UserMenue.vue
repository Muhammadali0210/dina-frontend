<template>
    <button v-if="token" type="button" @click="isOpenMenue = !isOpenMenue"
        ...
        <img class="w-8 h-8 rounded-full" src="../assets/icons/user-avatar2.png" alt="user photo" />
    </button>
    <button @click="$router.push('/login')" v-else type="button"
    ...
    <div v-if="isOpenMenue && token"
        ...
        <ul class="py-1 text-gray-700 dark:text-gray-300">
            <li @click="logOut()" class="cursor-pointer">
                <div class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                    Chiqish</div>
            </li>
        </ul>
    </div>
