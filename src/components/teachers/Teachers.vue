<template lang="">
    <div class="">
        <div class="flex items-center max-md:items-start max-lg:gap-2 justify-between flex-col flex-wrap md:flex-row pb-4 bg-transparent dark:bg-gray-900">
            <div class="">
                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block p-[8px] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="flex items-center space-x-4 max-md:w-full"> 
                <button @click="$router.push('/teachers/add')" type="button" class="px-5 py-[6px] text-sm font-medium text-white inline-flex items-center bg-green-500 hover:opacity-80 focus:ring-4 focus:outline-none  rounded-lg text-center dark:bg-green-500 dark:hover:opacity-80 ">
                ...
                <div class="relative max-md:w-full">
                    ...
                    <input type="text" id="table-search-users" class="block max-md:w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 max-sm:w-[100%] bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users">
                </div>
            </div>
        </div>
                    ...
                    <tr v-for="(item, index) in 14" :key="index" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-900 dark:text-white">
                        ...
                        <td class="px-6 py-4 relative">
                            <div class="flex gap-3 h-[18px]">
                                <span class="cursor-pointer" @click="updateItem(5)">
                                    <img src="../../assets/icons/edit.svg" alt="E">
                                </span>
                                <span class="cursor-pointer" @click="openDeleteModal(2)">
