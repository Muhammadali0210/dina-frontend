                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="dropdown dropdown-bottom w-full">
                                ...
                                <ul tabindex="0" class="dropdown-content menu z-[10] p-2 w-[300px] bg-white divide-y divide-green-100 rounded-lg shadow dark:bg-green-700 dark:divide-green-600">
                                    <li v-if="groups" v-for="(group, index)  in groups" :key="index">
                                        <a class="cursor-pointer">
                                            <input :id="group._id" v-model="userData.group_ids" :value="group._id" :checked="userData.group_ids.includes(group._id)" type="checkbox" class="w-4 h-4 text-green-600 bg-green-100 border-green-300 rounded-sm">
