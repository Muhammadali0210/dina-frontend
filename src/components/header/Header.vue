<template >
    <nav class="bg-white border-b border-gray-200 sm:px-4 max-sm:px-1 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex justify-start items-center">
          ...
          <div class="flex items-center justify-between mr-0">
            <img
              ...
              alt="Dina Logo"
            />
            <span class="self-center max-sm:hidden text-2xl font-semibold whitespace-nowrap dark:text-white">DinaKorean</span>
          </div>
          <!-- search input -->
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button
            ...
            class="p-2 max-sm:hidden  ml-5 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
          >
