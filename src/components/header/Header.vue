<template >
    <nav class="bg-white/55 backdrop-blur-md border-b border-gray-200 sm:px-4 max-sm:px-1 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
