<template>
  ...
  <swiper :slidesPerView="'auto'" :spaceBetween="20" :loop="true" :loopFillGroupWithBlank="true" :freeMode="true"
    :pagination="false" :modules="modules" class="mySwiper" :autoplay="{
      delay: 1500,
      disableOnInteraction: false,
    }">
    <swiper-slide v-for=" (book, index) in books" :key="index" class="max-h-[400px] max-w-[250px]">
      <div
        class="max-w-sm drop-shadow-2xl bg-white border border-gray-200 rounded-lg  dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
          <img class="w-[250px] h-[230px] rounded-t-lg" src="../../assets/image/stb.jpg" :alt="book.title" />
        </a>
        <div class="p-5">
          <a href="#">
          ...
          <button type="button"
            class="inline-flex ml-[15px] items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Yuklash
