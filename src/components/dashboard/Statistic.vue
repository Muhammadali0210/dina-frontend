<template>
    <div class="grid grid-cols-3 gap-4 max-md:grid-cols-1">
        ...
        <div
            class=" bg-white dark:bg-slate-800 shadow-lg p-[15px] max-md:p-[10px] max-md:rounded-[20px] flex justify-start gap-4 items-center">
            <div
        ...
        <div
            class=" bg-white dark:bg-slate-800 shadow-lg max-md:rounded-[20px] p-[15px] max-md:p-[10px] flex justify-start gap-4 items-center">
            <div
