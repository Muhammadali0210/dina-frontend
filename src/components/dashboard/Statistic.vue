<template>
    <div class="grid grid-cols-3 gap-4 max-md:grid-cols-1">
        ...
        <div
            class="rounded-[20px] bg-white dark:bg-slate-800 shadow-lg p-[15px] max-md:p-[10px] max-md:rounded-[20px] flex justify-start gap-4 items-center">
            <div
                class="w-[65px] h-[65px] max-md:w-[55px] max-md:h-[55px]   bg-[#b7cdef5d] rounded-[45%] relative items-center">
        ...
        <div
            class="rounded-[20px] bg-white dark:bg-slate-800 shadow-lg max-md:rounded-[20px] p-[15px] max-md:p-[10px] flex justify-start gap-4 items-center">
            <div
