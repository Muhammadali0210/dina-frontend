<template>
    <div class="bg-white dark:bg-gray-800 p-4 rounded-md max-w-[1400px] mx-auto">
        <div>
            ...
            <div class="flex justify-between items-center border-b border-gray-600 mb-4 pb-4">
                ...
                <!-- Qidiruv panelini o'ng tomonga joylashtirish -->
                <div class="order-2 md:order-3 col-span-3 md:col-span-3 flex justify-end">
                    <div class="flex items-center space-x-4 max-md:w-full">
                        <button @click="addHandler" type="button"
                            class="px-5 py-[6px] text-sm font-medium text-white inline-flex items-center bg-green-500 hover:opacity-80 focus:ring-4 focus:outline-none rounded-lg text-center dark:bg-green-500 dark:hover:opacity-80 ">
                        ...
                        <div class="relative max-md:w-full">
                            ...
                            <input type="text" id="table-search-users" v-model="searchQuery"
                                class="block max-md:w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 max-sm:w-[100%] bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <table
                                ...
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-0 py-3 max-md:hidden">
                                            Status
                                        </th>
